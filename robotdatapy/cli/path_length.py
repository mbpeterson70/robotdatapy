...
@dataclass
class PathLengthParams:

    time_tol: float = 10.0

def main():

    parser = argparse.ArgumentParser(description="Quick path length tool.")
    ...
    # Report path length
    print(f"Path length: {pose_data.path_length():.3f} m")
